...
bool ParticleEngine::LoadResources()
{
	...
	const int32 slot = CTxdStore::AddTxdSlot("particleREPS2");
	...
	const char *required[] = {"flame1", "flame5", "rainsmall", "blood", "gameleaf01_64", "cloud3", "cloudmasked", "bloodsplat2", "gunge", "collisionsmoke", "bullethitsmoke", "gunshell", "wake_old", "pointlight", "smoke1", "smoke2", "smoke3", "smoke4", "smoke5", "smokeII_1", "smokeII_2", "smokeII_3", "smokeII_4", "smokeII_5", "rubber1", "rubber2", "rubber3", "rubber4", "rubber5", "splash1", "splash2", "splash3", "splash4", "splash5", "waterspray1", "waterspray2", "waterspray3", "explo01", "explo02", "explo03", "explo04", "explo05", "explo06", "gunflash1", "gunflash2", "gunflash3", "gunflash4", "raindrop1", "raindrop2", "raindrop3", "raindrop4", "splash_up1", "splash_up2", "birdf_01", "birdf_02", "birdf_03", "birdf_04", "cardebris_01", "cardebris_02", "cardebris_03", "cardebris_04", "carsplash_01", "carsplash_02", "carsplash_03", "carsplash_04"};
...
int32 slot = CTxdStore::FindTxdSlot("particleREPS2");
